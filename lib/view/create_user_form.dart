                          ...
                          onPressed: () async {
                            if (form_login_key.currentState.validate()) {
                              ...
                              if (text_conf_password.text !=
                                      text_password.text&&text_conf_password.text.length>9 &&
                                  text_password.text.length  >9||
                                  !text_email.text.contains('@gmail.com')) {
                                bool error_format =
                                    text_email.text.contains('@gmail.com');
                                print("format $error_format");
                                if (text_email.text.contains('@gmail.com')) {
                                ...
                                if (military_number.length >= 6 &&
                                  ...
                                  var create_user = await Get_And_Create_User()
                                      .create_user(
                                          username,
                                          degree,
                                          department,
                                  ...
                                  showMyDialog(context,
                                      '    يجيب ادخال الرقم العسكرى 6 رقم ورقم الهاتف 10 ارقام');
