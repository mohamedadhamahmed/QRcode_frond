                          ...
                          child: Container(
                            ...
                            child: RaisedButton(
                                ...
                                onPressed: () async {
                                 ...
                                 result_qrcode_generate=await Get_And_Create_Qrcode().create_Qrcode(
                                        QRcode(
                                            isused: false,
                                    ...
                                    text_place_name.clear();
                                     ...
                                     await _prefs.setString('id_qrcode', result_qrcode_generate);
                                     print('done' +result_qrcode_generate);
                                    Navigator.pushNamed(
                                      context,
                                      QRCreatePage.id,
                                      arguments: {
                                        'id': result_qrcode_generate
                                      },
                                    );
                                  }
                                },
...
search_id_contriller.clear();
                ...
                if(visitor!=null){
                  ...
                  await showMyDialog(
                      context, 'من فضلك أدخل رقم قومى او رقم عسكرى صحيح');
                }
